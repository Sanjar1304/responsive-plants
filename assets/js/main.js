...
function linkAction(){
    const navMenu = document.getElementById('nav-menu')
    // when we click each nav__links, we remove the show-menu class
    navMenu.classList.remove('show-menu')
}
...
function scrollHeader(){
    ...
    // when the scroll is greater than 80 viewport innerHeight, add the scroll-header class to the header tag
